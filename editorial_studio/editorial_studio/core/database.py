...
class Database:
    ...
    def _dict_to_tokens(self, data: dict) -> DesignTokens:
        return DesignTokens(
            ...
            body_font_family=data.get("body_font_family", "PT Serif"),
            heading_font_family=data.get("heading_font_family", "PT Sans"),
            mono_font_family=data.get("mono_font_family", "PT Mono"),
